...
public class ClassPro extends JFrame {
  ...
  public void initDisplay() {
    ...
    gpl = new ClassProLogic(this);
    prolist = gpl.getProList();
    ...
    jbtn_search.addActionListener(gpl);
    jbtn_lectureadd.addActionListener(gpl);
    jbtn_lecturedel.addActionListener(gpl);
    jbtn_cancel.addActionListener(gpl);
